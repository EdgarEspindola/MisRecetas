...
class AppDelegate: UIResponder, UIApplicationDelegate {
    ...
    internal func application(_ application: UIApplication, didFinishLaunchingWithOptions launchOptions: [UIApplicationLaunchOptionsKey: Any]?) -> Bool {
        ...
        UINavigationBar.appearance().barTintColor = UIColor(red: 240.0/255.0, green: 113.0/255.0, blue: 115.0/255.0, alpha: 1.0) // Color de la barra de navegación
        
        UINavigationBar.appearance().tintColor = UIColor.white // Color del texto de la barra de navegacion
